...
// Middleware :
// can be very useful for doing validations
// can log things from here or stop the
// request from continuing in the event that
// the request is not safe
// middleware to use for all requests
router.use(function(req, res, next) {
  console.log('FYI....This is something currently going down.....');
  next()
});
